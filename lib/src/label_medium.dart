...
/// A customizable text widget that follows the LabelMedium style as per Material Design.
///
...
class LabelMedium extends StatelessWidget {
  ...
  /// The size of the text, defaults to 12.0.
  ...
  /// Creates a [LabelMedium] widget with customizable text properties.
  ///
