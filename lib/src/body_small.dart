...
/// A customizable text widget that follows the BodySmall style as per Material Design.
///
...
class BodySmall extends StatelessWidget {
  ...
  /// The spacing between letters, defaults to 0.4.
  ...
  /// Creates a [BodySmall] widget with customizable text properties.
  ///
