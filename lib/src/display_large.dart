...
/// A customizable text widget that follows the DisplayLarge style as per Material Design.
///
...
class DisplayLarge extends StatelessWidget {
  ...
  /// The size of the text, defaults to 57.0.
  ...
  /// The spacing between letters, defaults to -0.25.
  final double letterSpacing;

  /// The height of the line, defaults to 1.12.
  ...
  /// Creates a [DisplayLarge] widget with customizable text properties.
  ///
