...
/// A customizable text widget that follows the TitleLarge style as per Material Design.
///
...
class TitleLarge extends StatelessWidget {
  ...
  /// The size of the text, defaults to 22.0.
  ...
  /// The height of the line, defaults to 1.27.
  ...
  /// Creates a [TitleLarge] widget with customizable text properties.
  ///
