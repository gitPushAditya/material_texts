...
/// A customizable text widget that follows the LabelSmall style as per Material Design.
///
/// This widget is a stateless wrapper around the [Text] widget, offering a set of
...
class LabelSmall extends StatelessWidget {
  ...
  /// The size of the text, defaults to 11.0.
  ...
  /// The height of the line, defaults to 1.45.
  ...
  /// Creates a [LabelSmall] widget with customizable text properties.
  ///
