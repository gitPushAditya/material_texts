...
/// A customizable text widget that follows the DisplaySmall style as per Material Design.
///
...
class DisplaySmall extends StatelessWidget {
  ...
  /// The size of the text, defaults to 36.0.
  ...
  /// The height of the line, defaults to 1.22.
  ...
  /// Creates a [DisplaySmall] widget with customizable text properties.
  ///
